...
public class CanteenOperatorDashboard extends javax.swing.JFrame {
    ...
    public CanteenOperatorDashboard() {
        ...
        List<FoodMenu> list2=dao.getFoodOrders();
        DefaultTableModel dtm2=(DefaultTableModel)jTable3.getModel();
        for(FoodMenu data:list2){
            Object obj[]={data.getOrderId(),data.getFoodName(),data.getFoodDescription(),data.getPatientId(),data.getCost(),data.getWardNo(),data.getStatus()};
            dtm2.addRow(obj);
        }
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        dao.updateFoodOrderStatus(id,status);
        JOptionPane.showMessageDialog(this,"Record Updated Successfully");
        new CanteenOperatorDashboard().setVisible(true);
        this.dispose();
